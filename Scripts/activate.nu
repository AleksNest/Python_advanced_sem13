...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Алексей\Desktop\GreekBrains\ДОМАШКА\Python_advanced\Seminar13'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Алексей\Desktop\GreekBrains\ДОМАШКА\Python_advanced\Seminar13\Scripts\deactivate.nu'
